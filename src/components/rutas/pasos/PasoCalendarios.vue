  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between sticky top-0 z-10 bg-white/95 py-2 border-b border-gray-100">
      <div>
        ...
        <!-- Mensaje de error general si no agregaron ningún calendario -->
        <p v-if="errores.calendarios" class="text-[11px] text-red-500 font-medium">
          {{ errores.calendarios }}
        </p>
      </div>
      <button 
              ...
              <input 
                ...
                :class="[
                  ...
                  errores.calendariosList?.[calIndex]?.nombre
                    ...
                    : 'border-dashed border-gray-300 focus:border-brand text-gray-700'
                ]"
              />
              <p v-if="errores.calendariosList?.[calIndex]?.nombre" class="text-[10px] text-red-500 font-medium mt-0.5">
                {{ errores.calendariosList[calIndex].nombre }}
              </p>
            </div>
          </div>
